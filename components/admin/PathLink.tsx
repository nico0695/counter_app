...
export default function PathLink({ slug }: { slug: string }) {
  ...
  async function onCopy(e: React.MouseEvent) {
    e.preventDefault();
    e.stopPropagation();
    try { await navigator.clipboard.writeText(fullUrl); show("Copiado al portapapeles"); } catch {}
  }
    ...
    <a className={styles.pathLink} href={href} target="_blank" rel="noopener noreferrer">
      ...
      <button className={styles.copyBtn} onClick={onCopy} aria-label="Copiar enlace">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
          ...
          <path d="M6 12H5C3.89543 12 3 11.1046 3 10V5C3 3.89543 3.89543 3 5 3H10C11.1046 3 12 3.89543 12 5V6" stroke="#9ca3af" strokeWidth="1.5"/>
        </svg>
      </button>
    </a>
  );
