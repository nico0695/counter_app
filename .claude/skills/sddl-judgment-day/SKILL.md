...
- judge prompts come from `references/judge-prompt.md`; findings follow `harness/sdd-lite/skills/_shared/sddl-review-ledger-contract.md`
...
- `harness/sdd-lite/skills/_shared/sddl-review-ledger-contract.md` (row contract and convergence buckets)
