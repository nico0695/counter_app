...
- `harness/sdd-lite/skills/_shared/sddl-review-ledger-contract.md` (ledger rules shared with judgment-day)
...
Use `harness/sdd-lite/templates/artifacts/review-ledger.md` as the baseline shape.
